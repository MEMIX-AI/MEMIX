...
export function ShareMenu({ assetId, title }: { assetId: string; title: string }) {
  ...
  return (
    <div className="relative" ref={ref}>
      <button
        onClick={() => setOpen((v) => !v)}
        className="flex items-center gap-1.5 rounded-xl border border-line bg-panel px-3.5 py-[11px] text-[13.5px] font-semibold text-text transition-colors duration-200 hover:border-accent/40"
      >
